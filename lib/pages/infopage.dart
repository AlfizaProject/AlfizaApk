                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(image: AssetImage('asset/1.jpeg'), fit: BoxFit.cover),
                      ),
                    ),
                    Container(
                      height: box,
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        image: const DecorationImage(image: AssetImage('asset/2.jpeg'), fit: BoxFit.cover),
                      ),
                    ),
                    Container(
                      height: box,
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        image: const DecorationImage(image: AssetImage('asset/3.jpeg'), fit: BoxFit.cover),
                      ),
                    )
                  ],
                ),
